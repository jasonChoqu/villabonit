...
export const DirectivityStoreSchema = yup.object().shape({
  name: yup
    .string()
  ...
  position: yup
    ...
    .max(2000, "La posición no puede exceder los 2000 caracteres"),
  photo: imageSchema,
});

export const DirectivityUpdateSchema = yup.object().shape({
  name: yup
    .string()
    .required("El nombre es requerido")
    .max(100, "El nombre no puede exceder los 100 caracteres"),
