...
import type { IGallery as IItemResource } from "@/core/types/IGallery";
...
const columns = [
  ...
  },
  {
    key: "area",
    header: "Área",
    render: (item: IItemResource) => <div className="font-bold">{item.area}</div>,
    sortable: true,
  },
  {
    key: "image",
...
export default function GalleryList() {
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="Galería" />
      <DataTable
